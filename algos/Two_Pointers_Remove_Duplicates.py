...
# Input: [2, 3, 3, 3, 6, 9, 9]
# Output: 4
# Explanation: The first four elements after removing the duplicates will
# be [2, 3, 6, 9].
...
# Input: [2, 2, 2, 11]
# Output: 2
# Explanation: The first two elements after removing the duplicates will
# be [2, 11].
...
# Output: 2
# Explanation: The first two elements after removing every 'Key' will be
# [11, 1].
